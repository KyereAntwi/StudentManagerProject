        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupIdentity = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueIdentifyer = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Activated = table.Column<bool>(type: "INTEGER", nullable: true),
                    ClassGroupId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ClassGroups_ClassGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassScore = table.Column<decimal>(type: "TEXT", nullable: false),
                    ExamScore = table.Column<decimal>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentSubjectRecords_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseTutor_AspNetUsers_TutorsId",
                        column: x => x.TutorsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CourseParagraphs",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Details = table.Column<string>(type: "TEXT", nullable: false),
                    CourseSubTopicId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseParagraphs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseParagraphs_CourseChapters_CourseSubTopicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseParagraphs_CourseSubTopicId",
                table: "CourseParagraphs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjectRecords_StudentId",
